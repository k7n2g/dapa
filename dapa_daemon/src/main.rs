...
#[derive(Parser)]
#[clap(version = VERSION, about = "DAPA Advanced Cryptocurrency with BlockDAG, Homomorphic Encryption, Zero-Knowledge Proofs, and Smart Contracts.")]
...
async fn main() -> Result<()> {
    ...
    info!("DAPAHE Blockchain running version: {}", VERSION);
    info!("----------------------------------------------");
...
fn build_prompt_message(prompt: &ShareablePrompt, topoheight: u64, median_topoheight: u64, network_hashrate: f64, peers_count: usize, rpc_count: usize, miners_count: usize, mempool: usize, network: Network) -> String {
    ...
    format!(
        "{} | {} | {} | {} | {} | {} | {} {}{} ",
        prompt.colorize_str(Color::Red, "DAPA Coin "),
        topoheight_str,
